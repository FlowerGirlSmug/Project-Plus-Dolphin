...
rm -rf ./AppDir/usr/Source/Core/DolphinQt/project-plus-dolphin-sgpm_autogen
rm ./AppDir/usr/Source/Core/DolphinQt/cmake_install.cmake
rm ./AppDir/usr/bin/project-plus-dolphin-sgpm-nogui
rm ./AppDir/usr/bin/dolphin-tool
mv ./AppDir/usr/share/project-plus-dolphin-sgpm/sys ./AppDir/usr/bin/Sys
rm -rf ./AppDir/usr/share/project-plus-dolphin-sgpm
sed -i 's/env QT_QPA_PLATFORM=xcb project-plus-dolphin-sgpm/project-plus-dolphin-sgpm/g' ./AppDir/usr/share/applications/project-plus-dolphin-sgpm.desktop
