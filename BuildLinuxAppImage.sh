...
rm -rf ./AppDir/usr/Source/Core/DolphinQt/brawlback-dolphin_autogen
rm ./AppDir/usr/Source/Core/DolphinQt/cmake_install.cmake
rm ./AppDir/usr/bin/brawlback-dolphin-nogui
rm ./AppDir/usr/bin/dolphin-tool
mv ./AppDir/usr/share/brawlback-dolphin/sys ./AppDir/usr/bin/Sys
rm -rf ./AppDir/usr/share/brawlback-dolphin
sed -i 's/env QT_QPA_PLATFORM=xcb brawlback-dolphin/brawlback-dolphin/g' ./AppDir/usr/share/applications/brawlback-dolphin.desktop
