...
rm -rf ./AppDir/usr/Source/Core/DolphinQt/project-plus-dolphin-revy_autogen
rm ./AppDir/usr/Source/Core/DolphinQt/cmake_install.cmake
rm ./AppDir/usr/bin/project-plus-dolphin-revy-nogui
rm ./AppDir/usr/bin/dolphin-tool
mv ./AppDir/usr/share/project-plus-dolphin-revy/sys ./AppDir/usr/bin/Sys
rm -rf ./AppDir/usr/share/project-plus-dolphin-revy
sed -i 's/env QT_QPA_PLATFORM=xcb project-plus-dolphin-revy/project-plus-dolphin-revy/g' ./AppDir/usr/share/applications/project-plus-dolphin-revy.desktop
