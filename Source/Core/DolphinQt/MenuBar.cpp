...
void MenuBar::AddHelpMenu()
{
  ...
  connect(website, &QAction::triggered, this,
          [] { QDesktopServices::openUrl(QUrl(QStringLiteral("https://x.com/BrawlbackTeam"))); });
  QAction* documentation = help_menu->addAction(tr("Brawlback Discord"));
  connect(documentation, &QAction::triggered, this, [] {
    QDesktopServices::openUrl(QUrl(QStringLiteral("https://discord.gg/dzYRN32k4D")));
  });
  QAction* github = help_menu->addAction(tr("&GitHub Repository"));
  connect(github, &QAction::triggered, this, [] {
    QDesktopServices::openUrl(QUrl(QStringLiteral("https://github.com/Brawlback-Team")));
  });
