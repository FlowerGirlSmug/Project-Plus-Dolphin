...
std::string ArtworkForGameId()
{
  ...
  {
    static constexpr char cover_url[] = "https://i.imgur.com/DP8uGPo.png";
                           ...
                           const std::string& current_game, bool reset_timer)
{
  ...
  {
    discord_presence.largeImageKey = "https://i.imgur.com/DP8uGPo.png";
    discord_presence.largeImageText = "RevyBuild Project+";
  }
